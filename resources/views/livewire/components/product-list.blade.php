        ...
        @foreach ($products as $product)
          <tr class="border-b-1 border-gray-300 last:border-b-0 hover:bg-gray-100"
            ...
            <td class="flex items-center justify-center gap-2 text-sm py-2 px-4 text-center font-medium">
              <a href="#" class="inline-block px-4 py-2 bg-blue-500 text-white rounded-md cursor-pointer">Edit</a>
              <a href="#"
                class="inline-block px-4 py-2 bg-red-500 text-white rounded-md cursor-pointer">Delete</a>
            </td>
          </tr>
        @endforeach
      </tbody>
